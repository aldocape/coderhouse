...
class MongoDB extends DAO {
    ...
    static getInstance(soloMongo) {
        if (!MongoDB.instance) {
            logger_1.default.info('Iniciando instancia de MongoDB en Factory');
...
class FileSystem extends DAO {
    ...
    static getInstance() {
        if (!FileSystem.instance) {
            logger_1.default.info('Iniciando instancia de FileSystem en Factory');
...
class Memory extends DAO {
    ...
    static getInstance() {
        if (!Memory.instance) {
            logger_1.default.info('Iniciando instancia de Memory en Factory');
