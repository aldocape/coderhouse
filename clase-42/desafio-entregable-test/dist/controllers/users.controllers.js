...
exports.signUpFunction = exports.loginFunction = exports.sendMail = exports.logout = exports.login = exports.updateUserController = exports.getAllUsersController = exports.signup = void 0;
...
const sendMail = (req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const email = yield email_1.EmailService.sendEmail(destination, subject, content);
    return email;
});
