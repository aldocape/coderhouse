...
function saveCart(cart) {
    return __awaiter(this, void 0, void 0, function* () {
        const newCart = yield (0, persistence_1.save)('cart', cart);
        return newCart;
    });
}
...
function getCartById(id) {
    return __awaiter(this, void 0, void 0, function* () {
        const cart = yield (0, persistence_1.getById)('cart', id);
        return cart;
    });
}
...
function deleteCartById(id) {
    return __awaiter(this, void 0, void 0, function* () {
        const cart = yield (0, persistence_1.deleteById)('cart', id);
        return cart;
    });
}
...
function updateCart(id, cart) {
    return __awaiter(this, void 0, void 0, function* () {
        const cartModified = yield (0, persistence_1.update)('cart', id, cart);
        return cartModified;
    });
}
