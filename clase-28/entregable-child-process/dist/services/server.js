...
exports.myHTTPServer = exports.PORT = void 0;
...
const args = (0, yargs_1.default)((0, helpers_1.hideBin)(process.argv)).default('port', 8080).argv;
...
// Leo el puerto de escucha a utilizar desde los argumentos pasados por línea de comandos
// Se tiene que usar la 'key' port
