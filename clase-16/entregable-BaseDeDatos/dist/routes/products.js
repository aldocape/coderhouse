...
router.post('/', auth_1.default, inputValidation_1.productValidator, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const newProd = yield products_1.add(newProduct);
    if (newProd) {
        res.status(201).json({
...
router.put('/:id', auth_1.default, inputValidation_1.productValidator, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const prod = yield products_1.update(modifiedProduct);
    if (prod.success)
        res.json({
...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const products = yield products_1.getAll();
    if (products.success) {
...
router.get('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield products_1.getById(id);
    if (result.success) {
        res.json(result);
    }
    else
...
router.delete('/:id', auth_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield products_1.deleteById(req.params.id);
    if (result.success)
        res.json({
