...
const graphql_services_1 = require("./graphql.services");
...
app.use('/graphql', (0, express_graphql_1.graphqlHTTP)({
    schema: graphql_services_1.graphqlSchema,
    rootValue: graphql_services_1.graphqlRoot,
    graphiql: true,
}));
...
myWSServer.on('connection', (socket) => {
    ...
    socket.on('newProduct', (product) => {
        ...
        // );
        const productModified = new products_dto_1.default(product, false);
