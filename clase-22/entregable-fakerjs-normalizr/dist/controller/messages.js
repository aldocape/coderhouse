...
exports.desnormalized = exports.getAllNormalized = exports.getAll = void 0;
...
const getAllNormalized = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        //El lean es para indicar que queremos como respuesta un objeto simple
        const messages = yield messages_1.default.find().lean();
        const normalizedData = normalizr_1.normalize(messages, finalSchema);
...
const desnormalized = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield fs_1.default.promises.readFile(normalizedPath, 'utf-8');
        const normalized = JSON.parse(data);
        const denormalizedData = normalizr_1.denormalize(normalized.result, finalSchema, normalized.entities);
...
exports.desnormalized = desnormalized;
